...
class CompiledApp {
  ...
  async instantiate(additionalImports, {loadDeferredWasm, loadDynamicModule} = {}) {
    ...
    const dart2wasm = {
      ...
      _1614: x0 => x0.apiKey,
      _1616: x0 => x0.authDomain,
      _1618: x0 => x0.databaseURL,
      _1620: x0 => x0.projectId,
      _1622: x0 => x0.storageBucket,
      _1624: x0 => x0.messagingSenderId,
      _1626: x0 => x0.measurementId,
      _1628: x0 => x0.appId,
      _1630: x0 => x0.name,
      _1631: x0 => x0.options,
      _1647: Date.now,
      _1649: s => new Date(s * 1000).getTimezoneOffset() * 60,
      _1650: s => {
      ...
      _1652: () => typeof dartUseDateNowForTicks !== "undefined",
      _1653: () => 1000 * performance.now(),
      _1654: () => Date.now(),
      _1657: () => new WeakMap(),
      _1658: (map, o) => map.get(o),
      _1659: (map, o, v) => map.set(o, v),
      _1660: x0 => new WeakRef(x0),
      _1661: x0 => x0.deref(),
      _1668: () => globalThis.WeakRef,
      _1671: s => JSON.stringify(s),
      _1672: s => printToConsole(s),
      _1673: (o, p, r) => o.replaceAll(p, () => r),
      _1675: Function.prototype.call.bind(String.prototype.toLowerCase),
      _1676: s => s.toUpperCase(),
      _1677: s => s.trim(),
      _1678: s => s.trimLeft(),
      _1679: s => s.trimRight(),
      _1680: (string, times) => string.repeat(times),
      _1681: Function.prototype.call.bind(String.prototype.indexOf),
      _1682: (s, p, i) => s.lastIndexOf(p, i),
      _1683: (string, token) => string.split(token),
      _1684: Object.is,
      _1685: o => o instanceof Array,
      _1690: a => a.pop(),
      _1691: (a, i) => a.splice(i, 1),
      _1692: (a, s) => a.join(s),
      _1693: (a, s, e) => a.slice(s, e),
      _1696: a => a.length,
      _1698: (a, i) => a[i],
      _1699: (a, i, v) => a[i] = v,
      _1701: o => {
      ...
      _1702: (o, offsetInBytes, lengthInBytes) => {
        var dst = new ArrayBuffer(lengthInBytes);
        new Uint8Array(dst).set(new Uint8Array(o, offsetInBytes, lengthInBytes));
        return new DataView(dst);
      },
      _1704: o => o instanceof Uint8Array,
      _1705: (o, start, length) => new Uint8Array(o.buffer, o.byteOffset + start, length),
      _1706: o => o instanceof Int8Array,
      _1707: (o, start, length) => new Int8Array(o.buffer, o.byteOffset + start, length),
      _1708: o => o instanceof Uint8ClampedArray,
      _1709: (o, start, length) => new Uint8ClampedArray(o.buffer, o.byteOffset + start, length),
      _1710: o => o instanceof Uint16Array,
      _1711: (o, start, length) => new Uint16Array(o.buffer, o.byteOffset + start, length),
      _1712: o => o instanceof Int16Array,
      _1713: (o, start, length) => new Int16Array(o.buffer, o.byteOffset + start, length),
      _1714: o => o instanceof Uint32Array,
      _1715: (o, start, length) => new Uint32Array(o.buffer, o.byteOffset + start, length),
      _1716: o => o instanceof Int32Array,
      ...
      _1720: o => o instanceof Float32Array,
      _1721: (o, start, length) => new Float32Array(o.buffer, o.byteOffset + start, length),
      _1722: o => o instanceof Float64Array,
      _1723: (o, start, length) => new Float64Array(o.buffer, o.byteOffset + start, length),
      _1724: (t, s) => t.set(s),
      _1726: (o) => new DataView(o.buffer, o.byteOffset, o.byteLength),
      _1728: o => o.buffer,
      _1729: o => o.byteOffset,
      _1730: Function.prototype.call.bind(Object.getOwnPropertyDescriptor(DataView.prototype, 'byteLength').get),
      _1731: (b, o) => new DataView(b, o),
      _1732: (b, o, l) => new DataView(b, o, l),
      _1733: Function.prototype.call.bind(DataView.prototype.getUint8),
      _1734: Function.prototype.call.bind(DataView.prototype.setUint8),
      _1735: Function.prototype.call.bind(DataView.prototype.getInt8),
      _1736: Function.prototype.call.bind(DataView.prototype.setInt8),
      _1737: Function.prototype.call.bind(DataView.prototype.getUint16),
      _1738: Function.prototype.call.bind(DataView.prototype.setUint16),
      _1739: Function.prototype.call.bind(DataView.prototype.getInt16),
      _1740: Function.prototype.call.bind(DataView.prototype.setInt16),
      _1741: Function.prototype.call.bind(DataView.prototype.getUint32),
      _1742: Function.prototype.call.bind(DataView.prototype.setUint32),
      _1743: Function.prototype.call.bind(DataView.prototype.getInt32),
      _1744: Function.prototype.call.bind(DataView.prototype.setInt32),
      _1747: Function.prototype.call.bind(DataView.prototype.getBigInt64),
      _1748: Function.prototype.call.bind(DataView.prototype.setBigInt64),
      _1749: Function.prototype.call.bind(DataView.prototype.getFloat32),
      _1750: Function.prototype.call.bind(DataView.prototype.setFloat32),
      _1751: Function.prototype.call.bind(DataView.prototype.getFloat64),
      _1752: Function.prototype.call.bind(DataView.prototype.setFloat64),
      _1765: (ms, c) =>
      setTimeout(() => dartInstance.exports.$invokeCallback(c),ms),
      _1766: (handle) => clearTimeout(handle),
      _1767: (ms, c) =>
      setInterval(() => dartInstance.exports.$invokeCallback(c), ms),
      _1768: (handle) => clearInterval(handle),
      _1769: (c) =>
      ...
      _1773: (x0,x1) => x0.test(x1),
      _1774: x0 => x0.pop(),
      _1776: o => o === undefined,
      _1778: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
      _1780: o => {
        const proto = Object.getPrototypeOf(o);
        return proto === Object.prototype || proto === null;
      },
      _1781: o => o instanceof RegExp,
      _1782: (l, r) => l === r,
      _1783: o => o,
      _1784: o => o,
      _1785: o => o,
      ...
      _1797: (o, p) => o[p],
      _1798: (o, p, v) => o[p] = v,
      _1799: (o, m, a) => o[m].apply(o, a),
      _1801: o => String(o),
      _1802: (p, s, f) => p.then(s, (e) => f(e, e === undefined)),
      _1803: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1803(f,arguments.length,x0) }),
      _1804: f => finalizeWrapper(f, function(x0,x1) { return dartInstance.exports._1804(f,arguments.length,x0,x1) }),
      _1805: o => {
      ...
      _1806: o => [o],
      _1807: (o0, o1) => [o0, o1],
      _1808: (o0, o1, o2) => [o0, o1, o2],
      _1809: (o0, o1, o2, o3) => [o0, o1, o2, o3],
      ...
      _1814: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmI32ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1815: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
      ...
      _1818: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const getValue = dartInstance.exports.$wasmF64ArrayGet;
        for (let i = 0; i < length; i++) {
          jsArray[jsArrayOffset + i] = getValue(wasmArray, wasmArrayOffset + i);
        }
      },
      _1819: (jsArray, jsArrayOffset, wasmArray, wasmArrayOffset, length) => {
        const setValue = dartInstance.exports.$wasmF64ArraySet;
        for (let i = 0; i < length; i++) {
          setValue(wasmArray, wasmArrayOffset + i, jsArray[jsArrayOffset + i]);
        }
      },
      _1820: x0 => new ArrayBuffer(x0),
      _1821: s => {
        if (/[[\]{}()*+?.\\^$|]/.test(s)) {
            s = s.replace(/[[\]{}()*+?.\\^$|]/g, '\\$&');
        }
      ...
      _1823: x0 => x0.index,
      _1825: x0 => x0.flags,
      _1826: x0 => x0.multiline,
      _1827: x0 => x0.ignoreCase,
      _1828: x0 => x0.unicode,
      _1829: x0 => x0.dotAll,
      _1830: (x0,x1) => { x0.lastIndex = x1 },
      _1831: (o, p) => p in o,
      _1832: (o, p) => o[p],
      _1849: () => new AbortController(),
      _1850: x0 => x0.abort(),
      _1851: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1852: (x0,x1) => globalThis.fetch(x0,x1),
      _1853: (x0,x1) => x0.get(x1),
      _1854: f => finalizeWrapper(f, function(x0,x1,x2) { return dartInstance.exports._1854(f,arguments.length,x0,x1,x2) }),
      _1855: (x0,x1) => x0.forEach(x1),
      _1856: x0 => x0.getReader(),
      _1857: x0 => x0.cancel(),
      _1858: x0 => x0.read(),
      _1861: x0 => x0.random(),
      _1864: () => globalThis.Math,
      _1874: Function.prototype.call.bind(Number.prototype.toString),
      _1875: Function.prototype.call.bind(BigInt.prototype.toString),
      _1876: Function.prototype.call.bind(Number.prototype.toString),
      _1877: (d, digits) => d.toFixed(digits),
      _3766: () => globalThis.window,
      _3828: x0 => x0.navigator,
      _4217: x0 => x0.userAgent,
      _6372: x0 => x0.signal,
      _8208: x0 => x0.value,
      _8210: x0 => x0.done,
      _8912: x0 => x0.url,
      _8914: x0 => x0.status,
      _8916: x0 => x0.statusText,
      _8917: x0 => x0.headers,
      _8918: x0 => x0.body,
      _12546: x0 => x0.name,
      _13292: x0 => x0.name,
